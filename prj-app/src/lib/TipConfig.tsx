	...
	return (
		<>
			...
			<div class='flex justify-center px-5 pt-4'>
				<div class='w-full border border-border-gray rounded-md'>
					<table class='w-full table-fixed font-medium text-sm'>
						<thead>
							<tr class='text-start text-table-header-gray hover:bg-menu-gray'>
								...
								<td class='py-2.5 px-2 w-[5rem]'>Total</td>
								<td class='py-2.5 px-2 w-[4rem]'>Offset</td>
								<td class='py-2.5 w-[3rem]'>
									{/* <svg
										class='w-full fill-table-header-gray'
										stroke-width='0'
									...
									{(entry, index) => (
										<>
											...
											<td class='p-3 border-r border-border-gray'>
												...
												<td class='w-[3rem] border-border-gray text-right'>
													<button
														class='my-1 mr-1 rounded-md hover:bg-border-gray text-white'
													...
													<td class='p-2 flex flex-col'>
														<div class='p-2 flex flex-col'>
															<div class='flex flex-row items-center'>
																<svg
																	class='mr-4 fill-table-header-gray'
																	stroke-width='0'
																	xmlns='http://www.w3.org/2000/svg'
																	viewBox='0 0 16 16'
																	height='1em'
														...
														<div class='p-2 flex flex-col'>
															<div class='flex flex-row items-center'>
																<svg
																	stroke-width='2'
																	xmlns='http://www.w3.org/2000/svg'
																	class='mr-4 stroke-table-header-gray icon icon-tabler icon-tabler-moneybag'
																	width='1em'
																	height='1em'
																	viewBox='0 0 24 24'
					...
					<div class='flex flex-row justify-between items-center border-t border-border-gray text-sm'>
						...
						<div class='m-2 pl-2 flex gap-2 border-l border-border-gray'>
							<button
								class='px-5 p-1 border border-border-gray rounded-md font-medium hover:bg-border-gray'
								onClick={async () => {
							...
							<button
								class='px-5 p-1 rounded-md text-black font-medium bg-white hover:bg-white/90'
								onClick={async () => {
									await addTipDistribution(props.date);
								}}
							>
			...
			{/* <div class='mt-4 mx-5 flex flex-row gap-4 justify-end text-sm'>
				<button
				...
				<button
					class='px-5 p-1.5 rounded-md text-black font-medium bg-white hover:bg-white/90'
					onClick={async () => {
						await addTipDistribution(props.date);
					}}
				>
